...
class RefreshManager(threading.Thread):
    ...
    def run(self):
        ...
        # Show information about the refresh operation in the Output Tab, as if
        #   it were being generated by youtube-dl
        if not self.init_obj:
            ...
            if isinstance(self.init_obj, media.Channel):
                media_type = 'channel'
            elif isinstance(self.init_obj, media.Playlist):
                media_type = 'playlist'
            else:
                media_type = 'folder'
