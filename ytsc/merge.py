...
if duration_v1 < (len(merge_v1_test_segments_audio)) or (duration_v1 > 20 * len(merge_v1_test_segments_audio)):
    print_warning("File of method 1 broken.")
    f1_working = False

if duration_v2 < (len(merge_v2_test_segments_audio)) or (duration_v2 > 20 * len(merge_v2_test_segments_audio)):
